...
- [`packages/harness/kkoclaw/agents/thread_state.py`](../packages/harness/kkoclaw/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/kkoclaw/agents/middlewares/title_middleware.py`](../packages/harness/kkoclaw/agents/middlewares/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/kkoclaw/config/title_config.py`](../packages/harness/kkoclaw/config/title_config.py) - 配置管理
- [`config.yaml`](../../config.example.yaml) - 配置文件
- [`packages/harness/kkoclaw/agents/lead_agent/agent.py`](../packages/harness/kkoclaw/agents/lead_agent/agent.py) - Middleware 注册
