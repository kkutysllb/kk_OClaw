...
#### [`packages/harness/kkoclaw/config/title_config.py`](../packages/harness/kkoclaw/config/title_config.py) (新建)
- ✅ 创建 `TitleConfig` 配置类
...
#### [`packages/harness/kkoclaw/agents/middlewares/title_middleware.py`](../packages/harness/kkoclaw/agents/middlewares/title_middleware.py) (新建)
