...
1. Start KKOCLAW locally using any working development setup you already use.
   ...
   If you already have KKOCLAW running locally, you can reuse that existing setup.
