"""Pure-argument factory for KKOCLAW agents.

``create_kkoclaw_agent`` accepts plain Python arguments — no YAML files, no
...
def create_kkoclaw_agent(
    ...
    *,
    ...
    """Create a KKOCLAW agent from plain Python arguments.
...
def _assemble_from_features(
    ...
    *,
    ...
    if feat.vision is not False:
        ...
        if feat.sandbox is not False:
            from kkoclaw.tools.builtins import view_image_tool
