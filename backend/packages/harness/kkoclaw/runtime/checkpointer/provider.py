...
Usage::
    ...
    from kkoclaw.runtime.checkpointer.provider import get_checkpointer, checkpointer_context
...
from kkoclaw.config.checkpointer_config import CheckpointerConfig
