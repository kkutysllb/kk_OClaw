...
and the embedded :class:`~kkoclaw.client.KKOCLAWClient`.
...
Usage::
    ...
    from kkoclaw.runtime.store.provider import get_store, store_context
...
def _sync_store_cm(config) -> Iterator[BaseStore]:
    ...
    :class:`~kkoclaw.config.checkpointer_config.CheckpointerConfig` instance —
...
def get_store() -> BaseStore:
    ...
    from kkoclaw.config.app_config import _app_config
    from kkoclaw.config.checkpointer_config import get_checkpointer_config
