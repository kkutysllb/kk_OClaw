...
from kkoclaw.runtime.stream_bridge import StreamBridge
...
async def run_agent(
    ...
    *,
    ...
    try:
        ...
        # Shared helper with ``KKOClawClient.stream`` so both entry points stay
        ...
        inject_langfuse_metadata(
            ...
            environment=os.environ.get("KK_OCLAW_ENV") or os.environ.get("ENVIRONMENT"),
        )
