...
DEFAULT_PORT = 8080
DEFAULT_CONTAINER_PREFIX = "kkoclaw-sandbox"
...
class AioSandboxProvider(SandboxProvider):
    ...
    def _load_config(self) -> dict:
        ...
        return {
            ...
            # provisioner URL for dynamic pod management (e.g. http://provisioner:9194)
    ...
    def _get_skills_mount() -> tuple[str, str, bool] | None:
        ...
        Mount source uses KKOCLAW_HOST_SKILLS_PATH when running inside Docker (DooD)
        ...
        try:
            ...
            if skills_path.exists():
                ...
                host_skills = os.environ.get("KKOCLAW_HOST_SKILLS_PATH") or str(skills_path)
