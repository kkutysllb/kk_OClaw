...
from kkoclaw.persistence.feedback import FeedbackRepository
from kkoclaw.runtime import RunContext, RunManager, StreamBridge
...
async def langgraph_runtime(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    Usage in ``app.py``::
        ...
        async with langgraph_runtime(app):
            yield
    """
    from kkoclaw.persistence.engine import close_engine, get_session_factory, init_engine_from_config
    from kkoclaw.runtime import make_store, make_stream_bridge
    ...
    async with AsyncExitStack() as stack:
        ...
        if sf is not None:
            from kkoclaw.persistence.feedback import FeedbackRepository
            from kkoclaw.persistence.run import RunRepository
