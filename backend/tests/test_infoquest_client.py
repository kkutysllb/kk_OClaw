...
from kkoclaw.community.infoquest import tools
from kkoclaw.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("kkoclaw.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("kkoclaw.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("kkoclaw.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/username/python/kkoclawv2/kkoclaw/backend/tests/test_infoquest_client.py
