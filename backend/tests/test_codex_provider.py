"""Tests for kkoclaw.models.openai_codex_provider.CodexChatModel.
...
from kkoclaw.models.credential_loader import CodexCliCredential
...
def _make_model(**kwargs):
    ...
    with patch("kkoclaw.models.openai_codex_provider.load_codex_cli_credential", return_value=cred):
