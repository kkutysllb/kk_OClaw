...
from kkoclaw.config.app_config import AppConfig, get_app_config, reset_app_config
...
def test_get_app_config_reloads_when_config_path_changes(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("KKOCLAW_EXTENSIONS_CONFIG_PATH", str(extensions_path))
    monkeypatch.setenv("KKOCLAW_CONFIG_PATH", str(config_a))
    reset_app_config()
    ...
    try:
        ...
        monkeypatch.setenv("KKOCLAW_CONFIG_PATH", str(config_b))
