...
Requirements:
    ...
    resolves kkoclaw-harness and app packages correctly:
...
async def main():
    ...
    # Delay the rest of the kkoclaw imports until *after* logging is installed
    # so that any import-time side effects (e.g. kkoclaw.agents starts a
    ...
    from kkoclaw.agents import make_lead_agent
    from kkoclaw.mcp import initialize_mcp_tools
