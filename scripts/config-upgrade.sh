...
if [ -n "$KKOCLAW_CONFIG_PATH" ] && [ -f "$KKOCLAW_CONFIG_PATH" ]; then
    CONFIG="$KKOCLAW_CONFIG_PATH"
...
MIGRATIONS = {
    1: {
        'description': 'Rename src.* module paths to kkoclaw.*',
        'replacements': [
            ('src.community.', 'kkoclaw.community.'),
            ('src.sandbox.', 'kkoclaw.sandbox.'),
            ('src.models.', 'kkoclaw.models.'),
            ('src.tools.', 'kkoclaw.tools.'),
        ],
    },
