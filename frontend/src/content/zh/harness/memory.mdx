...
memory:
  ...
  # 全局记忆文件的存储路径。
  # 默认：{base_dir}/memory.json（解析为 backend/.kkoclaw/memory.json）
...
- 基础目录：`backend/.kkoclaw/`
- 全局记忆：`backend/.kkoclaw/memory.json`
- 按 Agent 记忆：`backend/.kkoclaw/agents/{agent_name}/memory.json`
