...
memory:
  ...
  # Default: {base_dir}/memory.json  (resolves to backend/.kkoclaw/memory.json)
...
- Base directory: `backend/.kkoclaw/`
- Global memory: `backend/.kkoclaw/memory.json`
- Per-agent memory: `backend/.kkoclaw/agents/{agent_name}/memory.json`
