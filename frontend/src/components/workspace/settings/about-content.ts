/**
 * About KKOCLAW markdown content. Inlined to avoid raw-loader dependency
 * (Turbopack cannot resolve raw-loader for .md imports).
 */
export const aboutMarkdown = `# 🐎 [About KKOCLAW](https://github.com/bytedance/deer-flow)
...
* **Skills & Tools**: With built-in and extensible skills and tools, KKOCLAW can do almost anything.
...
Explore KKOCLAW on GitHub: [github.com/bytedance/deer-flow](https://github.com/bytedance/deer-flow)
...
KKOCLAW is proudly open source and distributed under the **MIT License**.

---

## 🙌 Acknowledgments

We extend our heartfelt gratitude to the open source projects and contributors who have made KKOCLAW a reality. We truly stand on the shoulders of giants.
...
These outstanding projects form the backbone of KKOCLAW and exemplify the transformative power of open source collaboration.
